...
class MailingList(models.Model):
    ...
    start = models.DateTimeField(default=datetime.now, verbose_name='start time UTC')
    finish = models.DateTimeField(default=datetime.now, verbose_name='finish time UTC')
